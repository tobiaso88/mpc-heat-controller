...
from app.entities import identity,discovery,payload,EntityPublisher,SENSORS
...
class EntityTests(unittest.TestCase):
    ...
    def test_values_missing_stale_and_demo(self):
        ...
        snapshot={'sampled_at':datetime.fromtimestamp(1000,timezone.utc).isoformat(),'config_used':c,'readings':[{'entity':'sensor.a','value':21,'quality':'OK'}],
