...
- Timprognos med separata diagram för temperatur, molntäckning och eventuell solinstrålning. Mätloggning och automatisk daglig träning av en husmodell efter minst 250 kompletta timmar.
- Molnighet kan hämtas och loggas direkt från vald väderentitet; ingen extra solsensor behövs. Temperaturmodellen finns som reserv.
